...
describe("DeployCost", function () {
  it("deploys all contracts", async function () {
...

    {
      ...
      const CrypToadzCustomImage4896 = await ethers.getContractFactory("CrypToadzCustomImage4896", { libraries: { CrypToadzCustomImageBank: CrypToadzCustomImageBankDeployed.address }});
      ...
      const CrypToadzCustomImage5471 = await ethers.getContractFactory("CrypToadzCustomImage5471", { libraries: { CrypToadzCustomImageBank: CrypToadzCustomImageBankDeployed.address }});
